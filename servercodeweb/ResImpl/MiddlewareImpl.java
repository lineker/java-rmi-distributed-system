...
*/	 
	...
	private URL getWebserviceURL(String server, int port)
	{
		 URL url = null;
	        try {
	            ...
	            url = new URL(baseUrl, "http://"+server+":"+new Integer(port).toString()+"/RmWeb?wsdl");
	        } catch (MalformedURLException e) {
	            System.out.println("Failed to create URL for the wsdl Location: 'http://localhost:9899/RmWeb?wsdl', retrying as a local file");
	...
	public MiddlewareImpl()
	{
		...
		URL flighturl = getWebserviceURL("localhost",9899);
		rm.rmwebservice.client.RmWebService service = new rm.rmwebservice.client.RmWebService(flighturl,new QName("http://webservice.rm/", "RmWebService"));
		rm.rmwebservice.client.RmWeb rmflight = service.getRmWebPort();
        
		rms.put("Flight", rmflight);
		
		//Add others RM just changing port and address
		URL carurl = getWebserviceURL("localhost",8899);
		rm.rmwebservice.client.RmWebService service2 = new rm.rmwebservice.client.RmWebService(carurl,new QName("http://webservice.rm/", "RmWebService"));
		rm.rmwebservice.client.RmWeb rmcar = service2.getRmWebPort();
        
		rms.put("Car", rmcar);
		
		//Add others RM just changing port and address
		URL hotelurl = getWebserviceURL("localhost",7899);
		rm.rmwebservice.client.RmWebService service3 = new rm.rmwebservice.client.RmWebService(hotelurl,new QName("http://webservice.rm/", "RmWebService"));
		rm.rmwebservice.client.RmWeb rmhotel = service3.getRmWebPort();
        
		rms.put("Hotel", rmhotel);
	}
	...
	public boolean addFlight(int id, int flightNum, int flightSeats,
		...
		rm.rmwebservice.client.RmWeb r = (rm.rmwebservice.client.RmWeb) rms.get("Flight");
		if(r != null)
		{
	...
	public boolean addCars(int id, String location, int numCars, int price)
		...
		rm.rmwebservice.client.RmWeb r = (rm.rmwebservice.client.RmWeb) rms.get("Car");
		if(r != null)
		{
	...
	public boolean addRooms(int id, String location, int numRooms, int price)
		...
		rm.rmwebservice.client.RmWeb r = (rm.rmwebservice.client.RmWeb) rms.get("Hotel");
		if(r != null)
		{
	...
	@Override
	public boolean newCustomerWithId(int id, int customerID) throws RemoteException {
		transaction_watcher.reset(id);
		System.out.println("newCustomer on middleware");
	...
	public boolean customerExist(int id, int customerID) throws RemoteException {
		System.out.println("inside MW, customer exist");
		Customer cust = null;;
		try {
			cust = (Customer) readData( id, Customer.getKey(customerID));
		} catch (DeadlockException e) {
